...
public class PlaneTest {
    ...
    public void before(){
        plane1 = new Plane(PlaneType.AIRBUSA380, 100, 100, 8000 );
        plane2 = new Plane(PlaneType.BOEING737, 10, 10, 1000 );
    }
    ...
    @Test
    public void canGetCargoCapacity(){
        assertEquals(100, plane1.getCargoCapacity());
    }
